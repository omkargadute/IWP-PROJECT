...
function ready(){ 
    ...
    for(var i=0;i<quantityInput.length;i++){
     ...
     var addtocart = document.getElementsByClassName('click')
...
function getScore(){
    // var add = document.getElementsByClassName('click')
    // for(var i=0;i<add.length;i++){
    //     var butt = add[i]
    //     console.log(butt)
    //     butt.addEventListener('click',addToCart)

    // }
    var n = this.getElementsByClassName("click :checked")
}
...
function addToCart(event){
    ...
    var image = item.getElementsByClassName('zoom')[0].src
